...
class Emu6502 {
    ...
    Running = true;
    //Registers
    registers16 = new Uint8Array(1);
    registers8 = new Uint8Array(5);
    get PC() { return this.registers16[0]; } // Program Counter
    set PC(n) { this.registers16[0] = n; } // Program Counter //TODO: understand why this doesnt work
    ...
    ExecuteInstruction() {
        if (!this.Storage)
            throw new RuntimeError('Rom is empty');
        ...
        if (this.Debug) {
            ...
            const num = bytes === 3 ? (this.getOpcode(1) << 8 | this.getOpcode(2)).toString(16) :
        ...
        if (this.Debug) {
            console.log(this.PC.toString(16).padStart(4, '0') + ' ' +
                instructionBytes
