...
exports.InterruptRequestVector_HI = exports.InterruptRequestVector_LO = exports.ResetVector_HI = exports.ResetVector_LO = exports.NonmaskableInterruptVector_HI = exports.NonmaskableInterruptVector_LO = exports.BranchInstructions = exports.JumpInstructions = exports.InstructionOpcodes = exports.AddressModes = void 0;
var AddressModes;
(function (AddressModes) {
    AddressModes[AddressModes["Absolute"] = 0] = "Absolute";
    AddressModes[AddressModes["AbsoluteX"] = 1] = "AbsoluteX";
    AddressModes[AddressModes["AbsoluteY"] = 2] = "AbsoluteY";
    AddressModes[AddressModes["Immediate"] = 3] = "Immediate";
    AddressModes[AddressModes["Implied"] = 4] = "Implied";
    AddressModes[AddressModes["Indirect"] = 5] = "Indirect";
    AddressModes[AddressModes["IndirectX"] = 6] = "IndirectX";
    AddressModes[AddressModes["IndirectY"] = 7] = "IndirectY";
    AddressModes[AddressModes["ZeropageRelative"] = 8] = "ZeropageRelative";
    AddressModes[AddressModes["ZeropageX"] = 9] = "ZeropageX";
    AddressModes[AddressModes["ZeropageY"] = 10] = "ZeropageY";
})(AddressModes = exports.AddressModes || (exports.AddressModes = {}));
exports.InstructionOpcodes = new Map([
    ['ADC', new Map([
            [AddressModes.Immediate, 0x69],
            [AddressModes.ZeropageRelative, 0x65],
    ...
    ['AND', new Map([
            ...
            [AddressModes.ZeropageRelative, 0x25],
    ...
    ['ASL', new Map([
            ...
            [AddressModes.ZeropageRelative, 0x06],
            [AddressModes.ZeropageX, 0x16],
            [AddressModes.Absolute, 0x0E],
            [AddressModes.AbsoluteX, 0x1E],
        ])],
    ['BCC', new Map([
            [AddressModes.ZeropageRelative, 0x90],
        ])],
    ['BCS', new Map([
            [AddressModes.ZeropageRelative, 0xB0],
        ])],
    ['BEQ', new Map([
            [AddressModes.ZeropageRelative, 0xF0],
        ])],
    ['BIT', new Map([
            [AddressModes.ZeropageRelative, 0x24],
            [AddressModes.Absolute, 0x2C],
        ])],
    ['BMI', new Map([
            [AddressModes.ZeropageRelative, 0x30],
        ])],
    ['BNE', new Map([
            [AddressModes.ZeropageRelative, 0xD0],
        ])],
    ['BPL', new Map([
            [AddressModes.ZeropageRelative, 0x10],
        ])],
    ['BRK', new Map([
            [AddressModes.Implied, 0x00],
        ])],
    ['BVC', new Map([
            [AddressModes.ZeropageRelative, 0x50],
        ])],
    ['BVS', new Map([
            [AddressModes.ZeropageRelative, 0x70],
        ])],
    ['CLC', new Map([
    ...
    ['CMP', new Map([
            ...
            [AddressModes.ZeropageRelative, 0xC5],
    ...
    ['CPX', new Map([
            ...
            [AddressModes.ZeropageRelative, 0xE4],
            [AddressModes.Absolute, 0xEC],
        ])],
    ['CPY', new Map([
            [AddressModes.Immediate, 0xC0],
            [AddressModes.ZeropageRelative, 0xC4],
            [AddressModes.Absolute, 0xCC],
        ])],
    ['DEC', new Map([
            [AddressModes.ZeropageRelative, 0xC6],
    ...
    ['EOR', new Map([
            ...
            [AddressModes.ZeropageRelative, 0x45],
    ...
    ['INC', new Map([
            [AddressModes.ZeropageRelative, 0xE6],
    ...
    ['LDA', new Map([
            ...
            [AddressModes.ZeropageRelative, 0xA5],
    ...
    ['LDX', new Map([
            ...
            [AddressModes.ZeropageRelative, 0xA6],
    ...
    ['LDY', new Map([
            ...
            [AddressModes.ZeropageRelative, 0xA4],
    ...
    ['LSR', new Map([
            ...
            [AddressModes.ZeropageRelative, 0x46],
    ...
    ['ORA', new Map([
            ...
            [AddressModes.ZeropageRelative, 0x05],
    ...
    ['ROL', new Map([
            ...
            [AddressModes.ZeropageRelative, 0x26],
    ...
    ['ROR', new Map([
            ...
            [AddressModes.ZeropageRelative, 0x66],
    ...
    ['SBC', new Map([
            ...
            [AddressModes.ZeropageRelative, 0xE5],
    ...
    ['STA', new Map([
            [AddressModes.ZeropageRelative, 0x85],
    ...
    ['STX', new Map([
            [AddressModes.ZeropageRelative, 0x86],
            [AddressModes.ZeropageY, 0x96],
            [AddressModes.Absolute, 0x8E],
        ])],
    ['STY', new Map([
            [AddressModes.ZeropageRelative, 0x84],
...
exports.JumpInstructions = ['JMP', 'JSR'];
...
exports.ResetVector_HI = 0xFFFD;
exports.InterruptRequestVector_LO = 0xFFFE;
exports.InterruptRequestVector_HI = 0xFFFF;
